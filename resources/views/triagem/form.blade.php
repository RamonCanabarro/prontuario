                             ...
                             <div class="form-group">
                                 ...
                                 <div class="row">
                                     <div class="col-md-3" align="left">
                                         ...
                                         <input type="text" disabled value="{{$dados['created_at']}}" class="form-control" name="data" id="data" required>
                                     </div>
                                 ...
                                 <div class="row">
                                     <div class="col-md-8" align="left">
                                         ...
                                         <input type="text" value="{{$dados['nome']}}" class="form-control" name="tx_nome" id="tx_nome" required>
                                     </div>
                                     <div class="col-md-4" align="left">
                              ...
                              <b>Tipos de atendimento</b>
                                    <div><b>Individual:</b>
                                        ...
                                        <label class="active" for="individualAdolescente">Adolescente</label>
                                            <input type="radio" name="tp_grupo" id="individualAdolescente"  value="individualAdolescente">
                                        ...
                                        <label class="active" for="individualIdoso">Idoso</label>
                                            <input type="radio" name="tp_grupo" id="individualIdoso" value="individualIdoso">

                                    </div>

                                    <div><b>Grupo:</b>
                                        <input type="radio" name="tp_grupo" id="grupoCrianca"
                                                   value="grupoCrianca"><label class="active" for="grupoCrianca">Criança</label>
                                         <input type="radio" name="tp_grupo" id="grupoAdolescente"
                                                   value="grupoAdolescente"><label class="active" for="grupoAdolescente">Adolescente</label>

                                         <input type="radio" name="tp_grupo" id="grupoMulher" value="grupoMulher"><label class="active" for="grupoMulher">Adulto</label>


                                            <input type="radio" name="tp_grupo" id="grupoHomem" value="grupoHomem"><label class="active" for="grupoHomem">Idoso</label>

                                        <div><b>Temporário:</b>
                                        <input type="radio" name="tp_grupo" id="temporarioCasal"
                                                   value="temporarioCasal"><label class="active" for="temporarioCasal"> Criança</label>
                                            <input type="radio" name="tp_grupo" id="temporarioFamiliar"
                        ...
                        <div class="input-field col s6">
                            ...
                            <label for="mensalidade" class="active">Se sim. Qual o valor da
                                mensalidade?</label>
                                    ...
                                    <div class="input-field col s6">
                                        <input type="number" id="nPessoas" class="input-field col s6" name="nu_qtd_pessoa">
                                    ...
                                    <div class="input-field col s6">
                                        <input type="radio" id="tp_deficiencia_sim" class="validate" name="tp_deficiencia"><label for="tp_deficiencia_sim">Sim.</label>
                                        <input type="radio" id="tp_deficiencia_nao" class="validate" name="tp_deficiencia"><label for="tp_deficiencia_nao">Não.</label>
                                    ...
                                    <div class="input-field col s6">
                                        <input type="radio" id="sim" name="tp_acompanhamento_psic"><label for="sim">Sim.</label>
                                        <input type="radio" id="nao" name="tp_acompanhamento_psic"><label for="nao">Não.</label>
                                    ...
                                    <div class="input-field col s6" align="left">
                                        ...
                                        <textarea rows="4" cols="50" class="validate" name="observacao" id="observacao" required
                                                  placeholder=""></textarea>
                                    </div>
                                </div>
