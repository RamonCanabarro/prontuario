                ...
                {{--<div class="card-content">--}}
                    ...
                    {{--<form method="post" action={{route('paciente.salvar')}}>--}}
                        ...
                        {{--<div class="input-field col s3">--}}
                            {{--<input type="text" id="tx_nome" name="tx_nome" value="{{$dados['tx_nome']}}" required class="validate"/>--}}
                            {{--<label for="tx_nome" class="">Nome</label>--}}
                        {{--</div>--}}
                        {{--<div class="input-field col s3">--}}
                            {{--<input type="text" id="nu_cpf" name="nu_cpf" {{$dados['nu_cpf']}} required class="validate"/>--}}
                            {{--<label for="nu_cpf">CPF:</label>--}}
                        {{--</div>--}}

                        {{--<div class="input-field col s3">--}}
                            {{--<input type="text" placeholder="" id="nu_rg" {{$dados['nu_rg']}} name="nu_rg" required class="validate"/>--}}
